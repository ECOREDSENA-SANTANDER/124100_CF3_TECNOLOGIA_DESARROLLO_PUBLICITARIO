...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4 El área de trabajo de Illustrator abarca todo lo que se ve cuando se abre por primera vez o se crea un documento: el panel de herramientas, la ventana de documento, la mesa de trabajo y los paneles. Se puede personalizar y guardar el espacio de trabajo para adaptarse al estilo de trabajo, para ampliar información, para ampliar información:
    ...
    p.mb-4 Se pueden crear documentos de Illustrator con un nuevo perfil de documento o de una plantilla para crear uno en blanco.
    ...
    p.mb-4 En Illustrator se pueden crear formas básicas y modificarlas de acuerdo con las necesidades que se tengan de diseño. El panel de formas básicas incluye varias muy útiles: cuadrado, elipse, estrella y polígono, entre las más importantes, para ello amplie información en el siguiente video:
    ...
    p.mb-4 Una vez los archivos han sido realizados deben ser guardados en diferentes formatos. El archivo fuente deberá hacerse desde el inicio e ir salvando todos los cambios importantes que se hagan, tal como se detalla en el siguiente video:
